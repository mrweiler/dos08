...
##### brief-self-control-survey and save as csv file
...
for (id in id_list) {
  ...
  # import json file
  data_list <- read_json(
    paste0("data/expfactory/", id, "_finished/brief-self-control-survey-results.json"))
...
# save as csv file
write_csv(x = tbl, path = "brief-self-control-survey-results-all.csv")
