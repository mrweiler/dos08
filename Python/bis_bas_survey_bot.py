...
# Survey part 1
answer_likert_items(question_block=2, number_of_questions=10, number_of_options=4)
click_button("Next")

# Survey part 2
answer_likert_items(question_block=12, number_of_questions=10, number_of_options=4)
click_button("Next")
