''' Bot to test experiment factory's eating-survey
...
def answer_likert_items(question_block, number_of_questions, number_of_options):
    ...
    for i in range(number_of_questions):
        answer = DRIVER.find_element_by_xpath(
            '//label[@for="option-eating-survey_%i_%i"]' % (
...
# Open website
DRIVER.get('https://expfactory-experiments.github.io/eating-survey/')
...
# Survey part 1
answer_likert_items(question_block=2, number_of_questions=6, number_of_options=4)
click_button("Next")

# Survey part 2
answer_likert_items(question_block=8, number_of_questions=6, number_of_options=4)
click_button("Next")

# Survey part 3
answer_likert_items(question_block=14, number_of_questions=5, number_of_options=4)
answer_likert_items(question_block=19, number_of_questions=1, number_of_options=8)
click_button("Next")
